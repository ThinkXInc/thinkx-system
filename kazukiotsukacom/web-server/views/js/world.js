...
//         );
		...
		var bmp = new createjs.Bitmap(CHAR_IMG_ROOT + cnames[c] + ".png");//new createjs.Bitmap(['img/char/',cnames[c],'.png'].join(''));
		bmp.x = 0;
		bmp.y = 0;
		bmp.scaleX = 0.5;
		bmp.scaleY = 0.5;
...
// ↓↓↓ add 25 05
function dispatchIntroFinishedEvent() {
	console.log('dispatch: introFinished')
	let introFinishedEvent = new Event('introFinished');
	document.dispatchEvent(introFinishedEvent);
}
