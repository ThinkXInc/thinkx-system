...
class Config:
    ...
    DISCORD_APPLY_WEBHOOK_URL = os.environ.get('DISCORD_APPLY_WEBHOOK_URL', '')
    DISCORD_INQUIRY_WEBHOOK_URL = os.environ.get('DISCORD_INQUIRY_WEBHOOK_URL', '')

    if env == "production":
        HOST_URL = "https://thinkxinc.com"
