...
(Evernote 原本: author 大塚一輝 / created 20251220T235553Z / updated 20251221T062439Z / raw/📃 k00bot2.enex)
...
data/candidates/candidates.jsonl は merge_candidates.py が 毎回作り直すため、 ここを直接編集すると次回 merge_candidates 実行で消えます。
#### 手動で投稿候補をつくる
