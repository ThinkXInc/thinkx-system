...
#
# Run k00bot2 from the monorepo and persist live data in kazukiotsuka/k00bot2.

## 最終配置

```text
/src/thinkx-system/k00bot2  実行コード・最新data・.env
...
1. `/src/thinkx-system/k00bot2/data` を `/src/k00bot2/data` へミラーする。
...
```zsh
ssh supercom-web1 'tail -20 /src/thinkx-system/k00bot2/data/log_daily.txt'
```
